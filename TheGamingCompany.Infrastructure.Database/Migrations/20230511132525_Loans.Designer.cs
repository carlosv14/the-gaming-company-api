...
namespace TheGamingCompany.Infrastructure.Database.Migrations
{
    ...
    [Migration("20230511132525_Loans")]
    partial class Loans
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TheGamingCompany.Core.Entities.Loan", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<bool>("IsReturnOperation")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("TheGamingCompany.Core.Entities.Loan", b =>
                {
                    b.HasOne("TheGamingCompany.Core.Entities.Game", "Game")
                        .WithMany("Loans")
